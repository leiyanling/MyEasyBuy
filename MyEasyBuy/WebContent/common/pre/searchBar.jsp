...
<div class="top">
    ...
    <div class="i_car">
        ...
        <div class="car_bg">
            ...
            <!--Begin 购物车已登录 Begin-->
            <ul class="cars">
                <c:forEach items="${sessionScope.cartVo.items}" var="temp">
                    <li>
                        ...
                        <div class="price"><font color="#ff4e00">￥${temp.product.price}</font> X${temp.count}</div>
                    </li>
                </c:forEach>
            </ul>
            <div class="price_sum">共计&nbsp;<font color="#ff4e00">￥</font><span>${sessionScope.cartVo.sum}</span></div>
            <c:if test="${sessionScope.loginUser==null}">
